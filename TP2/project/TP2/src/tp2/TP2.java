...
public class TP2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* tempo de processamento de cada estação na Linha 1 com o primeiro e 
        último elementos sendo o tempo de entrada e saida dessa linha, respectivamente */
        int[] tempoEstacao1 = new int[]{3, 5, 7, 10, 5, 9, 11, 9, 5, 2, 6};
        /* tempo de processamento de cada estação na Linha 2 com o primeiro e
        último elementos sendo o tempo de entrada e saida dessa linha, respectivamentes */
        int[] tempoEstacao2 = new int[]{2, 6, 3, 9, 11, 4, 9, 3, 12, 4, 5};

        // tempo de transporte de uma Estacao na Linha 1 até a Estacao seguinte na Linha 2 
        int[] tempoTransporte1 = new int[]{3, 5, 4, 2, 7, 5, 8, 1};
        // tempo de transporte de uma Estacao na Linha 2 até a Estacao seguinte na Linha 1
        int[] tempoTransporte2 = new int[]{5, 3, 7, 5, 6, 2, 5, 2};

        Linha1 = new LinhadeMontagem(tempoEstacao1, tempoTransporte1);  //cria a linha 1 com seus respectivos custos de estações e transportes
        Linha2 = new LinhadeMontagem(tempoEstacao2, tempoTransporte2);  //cria a linha 2 com seus respectivos custos de estações e transportes
        ...
        Linha1 = new LinhadeMontagem(tempoEstacao1, tempoTransporte1);  //cria a linha A1 com seus respectivos custos de estações e transportes
        Linha2 = new LinhadeMontagem(tempoEstacao2, tempoTransporte2);  //cria a linha A2 com seus respectivos custos de estações e transportes
